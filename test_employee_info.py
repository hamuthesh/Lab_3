...
def test_get_by_age():
    ...
    lower_limit = 26
    upper_limit = 33
    test_reuslt = EMPI.get_employees_by_age_range(lower_limit,upper_limit)
    assert (test_reuslt == expected_result)